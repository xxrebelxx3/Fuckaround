...
marijuana_f.add_to_inventory(fannypack, 5)
marijuana_f.add_to_inventory(fannypack, 5)
marijuana_f.add_to_inventory(fannypack, 5)
marijuana_b.add_to_inventory(backpack, 2)
marijuana_b.add_to_inventory(fannypack, 5)
marijuana_f.add_to_inventory(backpack, 20)
fannypack.show()
backpack.show()